...
const Decarbonization = () => {
  ...
  useInsightReadingHistoryTracker('decarbonization', 'Thailand Decarbonization Report', 'タイ脱炭素化レポート', 'Sustainability', hasFullAccess);
        ...
        <main className="flex-1 container mx-auto px-4 py-6 md:py-12 max-w-4xl">
          ...
          <section className="mb-8 md:mb-12">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 text-sm text-muted-foreground mb-6">
              ...
              <BookmarkButton article={{ slug: 'decarbonization', title: isJapanese ? 'タイ脱炭素化レポート' : 'Thailand Decarbonization Report', language: lang === 'ja' ? 'JP' : 'EN', url: '/insights/reports/decarbonization', category: 'Sustainability' }} variant="button" />
            </div>
          </section>
