...
const ThaiGovPolicyJapanese = () => {
  ...
  const tocSections = [
    ...
    { id: 'facts', label: isJapanese ? '市場・政策・動向に関する情報' : 'Facts (Policy, Regulation & Trends)' },
        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <section id="facts" className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold">{isJapanese ? '市場・政策・動向に関する情報' : 'Facts (Policy, Regulation & Trends)'}</h2>
