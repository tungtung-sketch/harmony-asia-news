...
const premiumInsightResults: SearchResult[] = [
  ...
  },
  {
    ...
    url: '/insights/reports/thailand-market-strategy',
    isPremium: true,
  ...
  },
  {
    ...
    url: '/insights/agriculture/industry-trends',
    isPremium: true,
  ...
  },
  {
    ...
    url: '/insights/real-estate/market-2026',
    isPremium: true,
  ...
  },
  {
    ...
    category: 'Premium Report - Manufacturing',
    categoryJa: 'プレミアムレポート - 製造業',
    url: '/insights/services/decarbonization',
    isPremium: true,
  ...
  },
  {
    ...
    category: 'Premium Report - Manufacturing',
    categoryJa: 'プレミアムレポート - 製造業',
    url: '/insights/services/energy-industry',
    isPremium: true,
  ...
  },
  {
    ...
    category: 'Premium Report - Manufacturing',
    categoryJa: 'プレミアムレポート - 製造業',
    url: '/insights/services/hormuz-crisis-impact',
    isPremium: true,
  ...
  },
  {
    ...
    category: 'Premium Report - Manufacturing',
    categoryJa: 'プレミアムレポート - 製造業',
    url: '/insights/services/oil-crisis-thai-industry',
    isPremium: true,
