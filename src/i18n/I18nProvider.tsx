...
const translations: Record<Lang, Translations> = {
  en: {
    ...
    // Auth
    "auth.title": "Sign In - HARMONY Asia News",
    "auth.description": "Sign in to access premium content and business intelligence",
    ...
    "auth.login.successMessage": "You have successfully signed in.",
    "auth.login.error": "Login Error",
    "auth.login.errorMessage": "Unable to sign in. Please try again.",
    "auth.signup.title": "Sign Up",
    "auth.signup.submit": "Create Account",
    "auth.signup.success": "Account Created!",
    "auth.signup.successMessage": "Please check your email to verify your account, then sign in.",
    "auth.signup.error": "Sign Up Error",
    "auth.signup.errorMessage": "Unable to create account. Please try again.",
  ...
  ja: {
    ...
    // Auth
    "auth.title": "サインイン - HARMONY Asia News",
    "auth.description": "プレミアムコンテンツとビジネスインテリジェンスにアクセスするためにサインイン",
    "auth.welcome": "HARMONYへようこそ",
    "auth.subtitle": "アカウントにサインインするか、新しいアカウントを作成してください",
    "auth.email": "メールアドレス",
    ...
    "auth.fullName": "氏名",
    "auth.fullNamePlaceholder": "氏名を入力",
    "auth.loading": "読み込み中...",
    "auth.backToHome": "ホームに戻る",
    "auth.login.title": "ログイン",
    "auth.login.submit": "サインイン",
    "auth.login.success": "おかえりなさい！",
    "auth.login.successMessage": "正常にサインインしました。",
    "auth.login.error": "ログインエラー",
    "auth.login.errorMessage": "サインインできませんでした。もう一度お試しください。",
    "auth.signup.title": "新規登録",
    "auth.signup.submit": "アカウント作成",
    "auth.signup.success": "アカウント作成完了！",
    "auth.signup.successMessage": "アカウント確認のためメールをご確認の上、サインインしてください。",
    "auth.signup.error": "登録エラー",
    "auth.signup.errorMessage": "アカウントを作成できませんでした。もう一度お試しください。",
