...
const translations: Record<Lang, Translations> = {
  en: {
    ...
    "signup.form.emailPlaceholder": "Enter your email address",
    ...
    // Position options
    "signup.positions.ceo": "CEO/President",
    "signup.positions.executive": "Executive/C-Level",
    "signup.positions.manager": "Manager/Director",
    "signup.positions.analyst": "Analyst/Researcher",
    ...
    "signup.purposes.general": "General Interest",

    // My Page
    "myPage.title": "My Page - Harmony Asia News",
    "myPage.metaDescription": "Manage your subscription and view your profile",
    "myPage.hero.title": "My Page",
    "myPage.hero.subtitle": "Manage your subscription and profile",
    "myPage.profile.title": "Profile Information",
    "myPage.profile.name": "Name",
    "myPage.profile.email": "Email",
    "myPage.profile.position": "Position",
    "myPage.profile.industry": "Industry",
    "myPage.subscription.title": "Subscription Details",
    "myPage.subscription.currentPlan": "Current Plan",
    "myPage.subscription.status": "Status",
    "myPage.subscription.nextBilling": "Next Billing Date",
    "myPage.subscription.paymentHistory": "Payment History",
    "myPage.subscription.manageButton": "Manage Subscription",
    "myPage.subscription.upgradeButton": "Upgrade Plan",
    "myPage.subscription.cancelButton": "Cancel Subscription",
    "myPage.history.title": "Access History",
    "myPage.history.recentActivity": "Recent Activity",
    "myPage.actions.editProfile": "Edit Profile",
    "myPage.actions.downloadInvoice": "Download Invoice",
    "myPage.actions.contactSupport": "Contact Support",

    // Payment Success
    "paymentSuccess.title": "Payment Successful - Harmony Asia News",
    "paymentSuccess.metaDescription": "Your payment has been processed successfully. Welcome to Harmony Asia News!",
    "paymentSuccess.hero.title": "Payment Successful – Welcome to Harmony Asia News!",
    "paymentSuccess.details.title": "Subscription Details", 
    "paymentSuccess.details.plan": "Plan",
    "paymentSuccess.details.startDate": "Start Date",
    "paymentSuccess.details.renewalDate": "Next Billing Date",
    "paymentSuccess.details.customerInfo": "Customer Information",
    "paymentSuccess.details.confirmation": "Your subscription has been activated successfully",
    "paymentSuccess.benefits.title": "What's included in your subscription?",
    "paymentSuccess.benefits.newsAccess": "Full access to daily business & policy news",
    "paymentSuccess.benefits.premiumReports": "Premium industry reports and executive insights", 
    "paymentSuccess.benefits.pdfDownloads": "Downloadable PDF reports and analysis",
    "paymentSuccess.benefits.newsletter": "Weekly newsletter with curated insights",
    "paymentSuccess.actions.dashboard": "Go to My Page",
    "paymentSuccess.actions.news": "Back to News",
    "paymentSuccess.loading": "Loading payment details...",
  ...
  ja: {
    ...
    "signup.form.emailPlaceholder": "メールアドレスを入力してください",
    "signup.form.password": "パスワード",
    "signup.form.passwordPlaceholder": "安全なパスワードを作成してください",
    "signup.form.position": "役職",
    "signup.form.positionPlaceholder": "役職を選択してください",
    "signup.form.industry": "業種",
    "signup.form.industryPlaceholder": "業種を選択してください",
    "signup.form.purpose": "登録目的",
    "signup.form.purposePlaceholder": "目的を選択してください",
    "signup.form.plan": "サブスクリプションプラン",
    "signup.form.submitButton": "支払いに進む",
    "signup.form.loginLink": "既にアカウントをお持ちですか？サインイン",

    // Position options (Japanese)
    "signup.positions.ceo": "CEO・社長",
    "signup.positions.executive": "エグゼクティブ・C-Level",
    "signup.positions.manager": "マネージャー・ディレクター",
    "signup.positions.analyst": "アナリスト・研究者",
    ...
    "signup.purposes.general": "一般的な関心",

    // My Page (Japanese)
    "myPage.title": "マイページ - Harmony Asia News",
    "myPage.metaDescription": "サブスクリプションとプロフィールの管理",
    "myPage.hero.title": "マイページ",
    "myPage.hero.subtitle": "サブスクリプションとプロフィールの管理",
    "myPage.profile.title": "プロフィール情報",
    "myPage.profile.name": "名前",
    "myPage.profile.email": "メールアドレス",
    "myPage.profile.position": "役職",
    "myPage.profile.industry": "業種",
    "myPage.subscription.title": "サブスクリプション詳細",
    "myPage.subscription.currentPlan": "現在のプラン",
    "myPage.subscription.status": "ステータス",
    "myPage.subscription.nextBilling": "次回課金日",
    "myPage.subscription.paymentHistory": "支払い履歴",
    "myPage.subscription.manageButton": "サブスクリプション管理",
    "myPage.subscription.upgradeButton": "プランをアップグレード",
    "myPage.subscription.cancelButton": "サブスクリプションをキャンセル",
    "myPage.history.title": "アクセス履歴",
    "myPage.history.recentActivity": "最近のアクティビティ",
    ...
    "paymentSuccess.metaDescription": "決済が完了しました。Harmony Asia Newsへようこそ！",
    "paymentSuccess.hero.title": "決済が完了しました。Harmony Asia Newsへようこそ！",
    "paymentSuccess.details.title": "サブスクリプション詳細",
    "paymentSuccess.details.plan": "プラン",
    "paymentSuccess.details.startDate": "開始日",
    "paymentSuccess.details.renewalDate": "次回課金日",
    "paymentSuccess.details.customerInfo": "お客様情報",
    "paymentSuccess.details.confirmation": "サブスクリプションが正常にアクティベートされました",
    "paymentSuccess.benefits.title": "サブスクリプションに含まれるもの",
    "paymentSuccess.benefits.newsAccess": "日次ビジネス・政策ニュースへの完全アクセス",
    "paymentSuccess.benefits.premiumReports": "プレミアム業界レポートと経営者向けインサイト",
    "paymentSuccess.benefits.pdfDownloads": "ダウンロード可能なPDFレポートと分析",
    "paymentSuccess.benefits.newsletter": "厳選されたインサイトの週次ニュースレター",
    "paymentSuccess.actions.dashboard": "マイページへ",
    "paymentSuccess.actions.news": "ニュース一覧へ",
    "paymentSuccess.loading": "決済詳細を読み込み中...",
